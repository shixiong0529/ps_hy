...
export function CropSection() {
  ...
  return (
    <div className="px-3 py-2">
      <p className="mb-3 text-[12px] leading-relaxed text-ps-dim">
      ...
      <div className="mt-3 rounded-md border border-ps-border bg-ps-panel3 px-2 py-1.5 text-[11px] text-ps-muted">
        {view.zoom < 1
