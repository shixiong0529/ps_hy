  ...
  return (
    <div>
      <div className="flex gap-2 px-3 py-1.5">
        <NumberInput label="画板宽" value={w} min={16} onChange={setW} suffix="px" />
        <NumberInput label="画板高" value={h} min={16} onChange={setH} suffix="px" />
      </div>
      ...
      <div className="px-3 pb-2 text-[10px] leading-relaxed text-ps-muted">
        如需改变画布范围而不清空内容，请使用「裁剪画布」或「图像 → 画布旋转 90°」。
      </div>
    </div>
  )
}
